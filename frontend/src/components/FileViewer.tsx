//When a user selects a file, this FileViewser shows the file's name (path) and its content that can be closed by clicking a close button

import { X } from "lucide-react"; //close button
import { FileViewerProps } from "../types";

export function FileViewer({ file, onClose }: FileViewerProps) {
  //file is an object containing details about the file like path , content.
  if (!file) return null;
